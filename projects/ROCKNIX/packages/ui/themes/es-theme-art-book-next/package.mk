...
makeinstall_target() {
  mkdir -p ${INSTALL}/usr/share/themes/${PKG_NAME}
    ...
    # ROCKNIX add-on: system logo for OpenNOW (not present upstream). The theme
    # resolves carousel logos by convention (logos/${system.theme}.svg).
    cp -f ${PKG_DIR}/sources/opennow.svg ${INSTALL}/usr/share/themes/${PKG_NAME}/_inc/systems/logos/opennow.svg
}
